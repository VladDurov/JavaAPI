...
public class SAXQueryDemo {
   public static void main(String[] args){
      ...
      try {
         File inputFile = new File("/home/joker/IdeaProjects/JavaAPI/src/main/java/xml/sax/demo.xml");
         SAXParserFactory factory = SAXParserFactory.newInstance();
         SAXParser saxParser = factory.newSAXParser();
          UserHandlerQuery userhandler = new UserHandlerQuery();
...
class UserHandlerQuery extends DefaultHandler {
